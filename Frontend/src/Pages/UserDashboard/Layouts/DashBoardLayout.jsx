  ...
  const notifications = [
    {
      ...
      description:
        'Your file "Project Proposal.pdf" has been successfully merged.',
      time: "5 minutes ago",
      unread: true,
    },
    {
      ...
      description:
        "You've used 85% of your available storage. Consider upgrading.",
      time: "2 hours ago",
      unread: true,
    },
    {
      ...
      description:
        "We've upgraded our encryption standards for better security.",
      time: "1 day ago",
      unread: true,
    },
  ];
      ...
      >
        ...
        <Box
          ...
          sx={{
            ...
            height: "20rem",
            background:
              "radial-gradient(circle, rgba(125, 249, 255, 0.2) 0%, rgba(125, 249, 255, 0) 70%)",
            filter: "blur(50px)",
            borderRadius: "50%",
            mixBlendMode: "screen",
            zIndex: 0,
        ...
        <Box
          ...
          sx={{
            ...
            height: "20rem",
            background:
              "radial-gradient(circle, rgba(104, 54, 230, 0.2) 0%, rgba(125, 249, 255, 0) 70%)",
            filter: "blur(50px)",
            borderRadius: "50%",
            mixBlendMode: "screen",
            zIndex: 0,
